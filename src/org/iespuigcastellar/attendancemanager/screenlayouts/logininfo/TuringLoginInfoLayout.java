...
public class TuringLoginInfoLayout extends VerticalLayout {
	...
	public void attach() {
		Embedded item = new Embedded("", new ClassResource("screenlayouts/logininfo/turing.jpg", getApplication())); 
		addComponent(item);

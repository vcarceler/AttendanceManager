...
public class MicroscopeLoginInfoLayout extends VerticalLayout {
	...
	public void attach() {
		Embedded item = new Embedded("", new ClassResource("screenlayouts/logininfo/Hooke-microscope.png", getApplication())); 
		addComponent(item);

...
public class YosaBusonLoginInfoLayout extends VerticalLayout {
	...
	public void attach() {
		Embedded item = new Embedded("", new ClassResource("screenlayouts/logininfo/yosa_buson.jpg", getApplication())); 
		addComponent(item);

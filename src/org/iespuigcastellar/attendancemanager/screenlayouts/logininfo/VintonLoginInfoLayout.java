...
public class VintonLoginInfoLayout extends VerticalLayout {
	...
	public void attach() {
		Embedded item = new Embedded("", new ClassResource("screenlayouts/logininfo/vinton.jpg", getApplication())); 
		addComponent(item);
